...
const steps = [
  ...
  },
  {
    ...
    description: 'Agile sprints with daily updates. Every feature ships with automated tests, code reviews, and continuous integration for zero-surprise deployments.',
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round">
