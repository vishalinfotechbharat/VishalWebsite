...
const benefits = [
  ...
  },
  {
    ...
    desc: 'Our support continues well beyond launch, with maintenance, improvements, and help always within reach.',
  },
  {
  ...
  },
  {
    ...
    desc: 'We measure success by your product\'s real-world performance - conversions, retention, and load time - not simply deliverables.',
  },
  {
...
const codeLines = [
  ...
  { key: 'communication', val: '"open + transparent"',    color: '#F472B6' },
      ...
      <div className={styles.why__layout}>
        ...
        <div className={styles.why__content}>
          <SectionHeader
            ...
            title={<>A Trusted Partner Who <span>Genuinely Cares</span></>}
            description="We bring engineering discipline, design sensibility, and transparent communication to every project we take on."
            align="left"
          />
          <motion.div
